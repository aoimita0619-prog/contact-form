    ...
    <div class="contact-form__content">
      ...
      <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__input--name">
              <input type="text" name="last_name" autocomplete="family-name" placeholder="例:山田" value="{{ old('last_name') }}"/>
              <input type="text" name="first_name" autocomplete="given-name" placeholder="例:太郎" value="{{ old('first_name') }}"/>
            </div>
        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__group--radio" id="gender">
